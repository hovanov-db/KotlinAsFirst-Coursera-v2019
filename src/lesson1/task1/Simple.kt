...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double {
    val arshins_vershoks = 48.0/3.0
    val sagenes_vershoks = 48
    val metrs = 4.445e-2 * (sagenes * sagenes_vershoks + arshins * arshins_vershoks + vershoks)
    return metrs
}
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = PI / 180 * (deg + (min + sec / 60.0) / 60.0)
...
/**
 * своя главная функция
 */
fun main(args: Array<String>) {
    val res = numberRevert(639)
